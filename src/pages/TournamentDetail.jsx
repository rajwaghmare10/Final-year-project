  ...
  return (
    <div className={`detail-content ${isOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
      ...
      <div className='tournament-info'>
        <div className='tournament-name-joinbtn'>
      ...
      <div className='content-display'>
        ...
        {activeContent === 'credentials' && <Credentials data={scrimOrTournamentdetails} type={type} />}
        {activeContent === 'result' && <Result data={scrimOrTournamentdetails} type = {type} />}
      </div>
